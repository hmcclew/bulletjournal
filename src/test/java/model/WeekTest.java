...
public class WeekTest {
    ...
    void testMaxTasksExceeded() {
        ...
        week.addTask(task1);
        week.addTask(task2);
        // Maximum tasks for MONDAY haven't been exceeded yet
        assertTrue(week.maxTasksExceeded());
        week.addTask(task3);
        // Adding third task to MONDAY should make it exceed the max tasks
        assertTrue(week.maxTasksExceeded());
    }
    ...
    void testMaxEventsExceeded() {
        ...
        week.addEvent(event1);
        week.addEvent(event2);
        // Maximum events for MONDAY haven't been exceeded yet
        assertTrue(week.maxEventsExceeded());
        week.addEvent(event3);
        // Adding third event to MONDAY should make it exceed the max events
        assertTrue(week.maxEventsExceeded());
    }
